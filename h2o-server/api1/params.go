...
func BindBody(c *gin.Context, p interface{}) error {
	return GetValidParams(c, p, BindTypeBody)
}

func BindQuery(c *gin.Context, p interface{}) error {
	return GetValidParams(c, p, BindTypeQuery)
}

func BindPath(c *gin.Context, p interface{}) error {
	return GetValidParams(c, p, BindTypePath)
}

func BindHeader(c *gin.Context, p interface{}) error {
	return GetValidParams(c, p, BindTypeHeader)
}
